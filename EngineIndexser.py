...
class Data_Creator():
    ...
    def convert_pdf_to_png(self):
        ...
        for file in local_file_list:
            ...
            while dpi>0:
                try:
                    pages = convert_from_path(file[0], dpi)
                except:
                    dpi-=100
                else:
                    dpi=0
            ...
            if (file_name == prev_file_name or prev_file_name == "") and png != local_png_list[-1]:
                ...
                if png == local_png_list[-1]:
                    if file_name == prev_file_name:
                        ...
                        self.writeTextFromPNG(png, to_write, prev_file_name)
                        to_write = text
                self.writeTextFromPNG(png, to_write, file_name)
                to_write = text
    ...
    def clean_text(self, to_clean):
        ...
        for potential_q in format_text:
            ...
            if "פתרון" not in potential_q and "משך הבחינה" not in potential_q:
    ...
    def writeTextFromPNG(self, png, to_write, file_name):
...
if __name__ == "__main__":
    dc = Data_Creator("C:\\Users\\User\\Documents\\Python Scripts\\Hackathon_BGU2019-master\\Hackathon_BGU2019-master")
